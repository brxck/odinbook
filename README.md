...
Creating a self-referential association in sqlite looks something like this. friend_id is a foreign key which actually points to another user in the users table.
